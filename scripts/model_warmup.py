...
def main():
    ...
    parser.add_argument("--warmup", action="store_true", help="Warmup models based on usage patterns")
    parser.add_argument("--recommendations", action="store_true", help="Show optimization recommendations")
    parser.add_argument("--auto-optimize", action="store_true", help="Run full automatic optimization")
